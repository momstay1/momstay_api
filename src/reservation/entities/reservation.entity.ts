...
export class ReservationEntity {
  ...
  @Column({ type: 'time', default: null, nullable: true, comment: '방문시간' })
  visitTime: Date | string;
  @Column({ type: 'date', default: null, nullable: true, comment: '입주날짜' })
  occupancyAt: Date | string;
  @Column({ type: 'date', default: null, nullable: true, comment: '퇴거날짜' })
